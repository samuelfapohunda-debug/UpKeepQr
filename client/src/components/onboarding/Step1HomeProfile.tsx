...
const HOME_TYPES = [
  {
    ...
    selectedClass: "border-blue-500 bg-blue-50 dark:bg-blue-950/30"
  },
  {
    value: "Condo",
    label: "Condo",
    ...
    selectedClass: "border-green-500 bg-green-50 dark:bg-green-950/30"
  },
  {
    value: "Townhouse",
    label: "Townhouse",
    ...
    selectedClass: "border-purple-500 bg-purple-50 dark:bg-purple-950/30"
  },
  {
    value: "Apartment",
    label: "Apartment",
    ...
    selectedClass: "border-orange-500 bg-orange-50 dark:bg-orange-950/30"
  }
];
...
export default function Step1HomeProfile({ data, onNext }: Step1Props) {
  ...
  const [dontKnowSquareFootage, setDontKnowSquareFootage] = useState(data.squareFootage === "Unknown");
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    hover:shadow-lg
                    ${isSelected 
                      ? `${type.selectedClass} border-2 shadow-md` 
                      : 'border-border bg-card hover:border-muted-foreground/50'
                    }
                  `}
                  data-testid={`button-home-type-${type.value.toLowerCase().replace(' ', '-')}`}
                >
                  {isSelected && (
                  ...
                  <Icon className={`h-12 w-12 mb-3 ${isSelected ? 'text-primary' : 'text-muted-foreground'}`} />
