...
const HouseShield = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path
      ...
      opacity="0.35"
    />
    <rect x="90" y="115" width="20" height="25" rx="2" fill="currentColor" opacity="0.4" />
  </svg>
);
...
const WrenchShape = ({ className }: { className?: string }) => (
  ...
  >
    <path
      ...
      opacity="0.32"
    />
    <circle cx="72" cy="22" r="12" fill="currentColor" opacity="0.25" stroke="currentColor" strokeWidth="1.5" strokeOpacity="0.3" />
  </svg>
);
...
const BellShape = ({ className }: { className?: string }) => (
  ...
  >
    <path
      ...
      opacity="0.32"
    />
    <circle cx="50" cy="76" r="6" fill="currentColor" opacity="0.38" />
    <rect x="47" y="8" width="6" height="10" rx="3" fill="currentColor" opacity="0.35" />
  </svg>
);
...
const CheckmarkShape = ({ className }: { className?: string }) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <circle cx="50" cy="50" r="40" fill="currentColor" opacity="0.2" stroke="currentColor" strokeWidth="2" strokeOpacity="0.28" />
    <path
...
const GearShape = ({ className }: { className?: string }) => (
  ...
  >
    <path
      ...
      strokeOpacity="0.22"
    />
    <circle cx="60" cy="42" r="12" fill="none" stroke="currentColor" strokeWidth="2.5" strokeOpacity="0.28" />
  </svg>
);
...
const CalendarShape = ({ className }: { className?: string }) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <rect x="15" y="25" width="70" height="60" rx="8" fill="currentColor" opacity="0.25" stroke="currentColor" strokeWidth="1.5" strokeOpacity="0.28" />
    <rect x="15" y="25" width="70" height="18" rx="8" fill="currentColor" opacity="0.32" />
    <rect x="30" y="15" width="6" height="16" rx="3" fill="currentColor" opacity="0.3" />
    <rect x="64" y="15" width="6" height="16" rx="3" fill="currentColor" opacity="0.3" />
    <rect x="28" y="55" width="10" height="10" rx="2" fill="currentColor" opacity="0.28" />
    <rect x="45" y="55" width="10" height="10" rx="2" fill="currentColor" opacity="0.28" />
    <rect x="62" y="55" width="10" height="10" rx="2" fill="currentColor" opacity="0.28" />
  </svg>
);
